            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        <div class="span4">
                        <p>Имя клиента</p>
                        <input type="text" name="userName" placeholder="" value="<?php echo $order['user_name']; ?>" disabled>

                        <p>Телефон клиента</p>
                        <input type="text" name="userPhone" placeholder="" value="<?php echo $order['user_phone']; ?>" disabled>

                        <p>Комментарий клиента</p>
                        <input type="text" name="userComment" placeholder="" value="<?php echo $order['user_comment']; ?>" disabled>

                        <p>Дата оформления заказа</p>
                        <input type="text" name="date" placeholder="" value="<?php echo $order['date']; ?>" disabled>
                        ...
                        <select name="delivery">
                            <option value="0" disabled <?php if ($order['delivery'] == 0) echo ' selected="selected"'; ?>>Без доставки</option>
                            <option value="1" disabled <?php if ($order['delivery'] == 1) echo ' selected="selected"'; ?>>Нужна доставка</option>
                        </select>
